...
},{"./lang":2,"./react":3,"./stores":6,"./util":7}],2:[function(require,module,exports){
(function (global){
'use strict';
...
var _assert = function _assert(assertion, message) {
  if (!assertion) {
...
var createNamespace = function createNamespace(fullName) {
  var ns = function ns() {
    return ns.__call__.apply(ns, arguments);
  };
  ns.__call__ = function __call__() {
...
var classifyNamespace = function classifyNamespace(ns, customSpec) {
  var spec = {
    ...
    __new__: function __new__(clazz) {
      var self = {};
      var keys = _.keys(clazz);
    ...
    __mixins__: [],
    __statics__: [],
    __init__: function __init__(clazz) {},
    __construct__: function __construct__() {},
    __fullname__: ns.__fullname__,
    getAttr: function getAttr(self, name) {
      return self._data[name];
    },
    setAttr: function setAttr(self, name, value) {
...
var namespace = function namespace(nsName, obj) {
...
var defineFunction = function defineFunction(ns, fnName, fn) {
...
var parsePriority = function parsePriority(arg) {
  arg = parseInt(arg);
...
var addHookFunction = function addHookFunction(fnMap, hookName, fn, priority) {
...
var removeHookFunction = function removeHookFunction(fnMap, hookName, fn, priority) {
  _assert(_.isString(hookName), 'The hook name should be a string.');
  _assert(_.isFunction(fn), 'The action or filter should be a function');
...
var addAction = function addAction(hookName, fn, priority) {
  addHookFunction(actions, hookName, fn, priority);
};

var addFilter = function addFilter(hookName, fn, priority) {
  addHookFunction(filters, hookName, fn, priority);
};

var removeAction = function removeAction(hookName, fn, priority) {
  removeHookFunction(actions, hookName, fn, priority);
};

var removeFilter = function removeFilter(hookName, fn, priority) {
...
var newHookableMultimethod = function newHookableMultimethod(ns, fnName, fn) {
  ...
  var _findMethod = function _findMethod() {
    var args = argumentsToArray(arguments);
  ...
  self.when = function when(matchFn, method) {
...
module.exports = {
  ...
  getSpecialWords: function getSpecialWords() {
...
},{"../lang":2,"./mixincompositor":4}],4:[function(require,module,exports){
(function (global){
'use strict';
...
var ns = lang.provide('birchpress.react.MixinCompositor', {
  ...
  getReactMixins: function getReactMixins(component) {
    return [];
  },

  componentWillMount: function componentWillMount(component) {
  ...
  componentWillReceiveProps: function componentWillReceiveProps(component, nextProps) {
    var mixins = component.getReactMixins();
    _.each(mixins, function(mixin) {
  ...
  shouldComponentUpdate: function shouldComponentUpdate(component, nextProps, nextState) {
    var result = true;
    var mixins = component.getReactMixins();
    var mergedMixin = {};
    _.each(mixins, function(mixin) {
  ...
  componentWillUpdate: function componentWillUpdate(component, nextProps, nextState) {
    var mixins = component.getReactMixins();
    _.each(mixins, function(mixin) {
  ...
  componentDidUpdate: function componentDidUpdate(component, prevProps, prevState) {
    var mixins = component.getReactMixins();
    _.each(mixins, function(mixin) {
...
},{"../lang":2}],5:[function(require,module,exports){
(function (global){
'use strict';
...
var clazz = lang.provide('birchpress.stores.ImmutableStore', {
  ...
  __construct__: function __construct__(self, data) {
    self.setAttr('cursor', self._createCursor(data));
  },

  getCursor: function getCursor(self) {
    return self.getAttr('cursor');
  },

  _createCursor: function _createCursor(self, data) {
    return Cursor.from(data, function(newData) {
      self.setAttr('cursor', self._createCursor(newData));
      self.onChange(self.getCursor());
    });
  },

  onChange: function onChange(self, newCursor) {}
...
},{"../lang":2,"immutable/contrib/cursor":8}],6:[function(require,module,exports){
'use strict';
...
},{"../lang":2,"./immutablestore":5}],7:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../lang":2}],8:[function(require,module,exports){
/**
...
},{"immutable":9}],9:[function(require,module,exports){
/**
 *  Copyright (c) 2014-2015, Facebook, Inc.
 *  All rights reserved.
 *
