		...
		<div class="sidebar">
			...
			<ul class="main-menu">
			 ...
			 <div class="credits">
			 	...
			 	<p class="hidden "><?php _e('Powered by','fukasawa'); ?> <a href="http://www.wordpress.org">WordPress</a>.</p>
			 	<p class="hidden "><?php _e('Theme by','fukasawa'); ?> <a href="http://www.andersnoren.se">Anders Nor&eacute;n</a>.</p>
