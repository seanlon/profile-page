=== Profile Builder - Maximum Character Length ===
...
Tested up to: 4.0
Stable tag: 1.0.0
Reguires Profile Builder at least: 2.0.5


Extends the functionality of Profile Builder by allowing you to set a maximum character length for the custom input and textarea fields.
...
1. Upload the profile-builder-mchl folder to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress


== Screenshots ==
1. Plugin Page: screenshot-1.jpg
2. Maximum Character Length Property: screenshot-2.jpg